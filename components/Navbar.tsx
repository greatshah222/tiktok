...
const Navbar = () => {
    ...
    return (
        <div className="w-full flex justify-between items-center border -b-2 bordeer-gray -200 py-2 px-4">
            <Link href={"/"}>
            ...
            <div>
                {userProfile ? (
                    ...
                    <>
                        <GoogleLogin onSuccess={(response) => createOrGetUser(response, addUser)} onError={() => console.log("err")} />
                    </>
                )}
            </div>
        </div>
